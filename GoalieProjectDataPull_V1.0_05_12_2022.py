...
def getStats(start_season,end_season):
    ...
    path = "C:/Users/AA/Documents/Hockey Data/Goalie Project/Goalie_Stats_RAW.csv"
...
def cleanData(df):
    ...
    path = "C:/Users/AA/Documents/Hockey Data/Goalie Project/Goalie_Stats_WRK.csv"
    df.to_csv(path) 
    return df
...
# The next block of code is to calculate the goalie stats to be tracked. Would be better in its own function for sake of readability, but is easier to keep here due to VGK and SEA recent expansions. Will put in function for future update
                    ...
                    starters.clear()
                    backups.clear()
    path = "C:/Users/AA/Documents/Hockey Data/Goalie Project/Goalie_Stats_Calc.csv"
    df.to_csv(path) 
    return df                                                                       
...
#Items for future updates (05/06/2022):
#Calculate/add advanced stats. (xG,GSAX)
#Export to SQL
#Contain block of code into seperate function for sake of readability.